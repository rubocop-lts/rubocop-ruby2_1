...
# rubocop-ruby2_1 Rakefile v7.0.0 - 2026-06-24
...
# rake install                                # Build and install rubocop-ruby2_1-1.0.0.gem in...
# rake install:local                          # Build and install rubocop-ruby2_1-1.0.0.gem in...
# rake kettle:jem:install                     # Internal target used by `kettle-jem install`
# rake kettle:jem:selftest                    # Self-test: template rubocop-ruby2_1 against itse...
